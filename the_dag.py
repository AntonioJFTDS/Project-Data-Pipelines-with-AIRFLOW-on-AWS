...
dag = DAG('udac_example_dag',
          ...
          schedule_interval='0 * * * *'  #It means the schedule is : Run once an hour at the beginning of the hour.
        )
...
run_quality_checks = DataQualityOperator(
    ...
    dag=dag ,
    redshift_conn_id="redshift",
    checks_list=[{'test_sql': "SELECT COUNT(*) FROM songplays", 'expected_result': 0, 'comparison': '>'},
